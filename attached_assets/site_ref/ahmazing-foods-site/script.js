...
const CATALOG = {
  ...
  products: {
    label: "Products",
    items: {
      "smoky-jollof-base": { name: "Smoky Jollof Base", sizes: { "Standard": 4500 } },
      "hibiscus-ginger": { name: "Hibiscus Ginger Concentrate", sizes: { "Standard": 3000 } },
      "pepper-mix": { name: "Premium Pepper Mix", sizes: { "Standard": 3500 } },
      "suya-marinade": { name: "Suya Marinade", sizes: { "Standard": 3000 } },
      "coconut-curry-base": { name: "Coconut Curry Base", sizes: { "Standard": 4000 } },
      "roasted-peanuts": { name: "Roasted Peanuts", sizes: { "Standard": 1800 } },
      "plantain-chips": { name: "Plantain Chips", sizes: { "Standard": 2200 } },
