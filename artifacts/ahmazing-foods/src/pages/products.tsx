...
const groups: { heading: string; sub: string; products: Product[] }[] = [
  ...
  {
    heading: "Snacks",
    sub: "Honest snacks — no MSG, no preservatives.",
    products: [
      { name: "Roasted Peanuts",             size: "Lightly salted · 200g",   price: "₦1,800",  img: "roasted-peanuts.jpg" },
      { name: "Coconut Shavings",            size: "Toasted & crunchy · 150g",price: "₦2,200",  img: "coconut-shavings.jpg" },
      { name: "Coated Peanuts",             size: "Spicy BBQ · 200g",         price: "₦2,000",  img: "coated-peanuts.jpg" },
      { name: "Yogurt Mix — Seed & Nut Blend", size: "200g",                  price: "₦2,800",  img: "yogurt-mix.jpg" },
      { name: "Peanut Butter",              size: "Creamy · 300g jar",        price: "₦4,000",  img: "peanut-butter.jpg" },
    ],
  },
  {
    heading: "Drinks & Wellness",
    sub: "Real ingredients, cold-pressed and bottled fresh.",
    products: [
      { name: "Zobo Drink",                  size: "Hibiscus infusion · 500ml",            price: "₦1,500",  img: "zobo-drink.jpg" },
      { name: "Yogurt Drink",                size: "Probiotic · 500ml",                    price: "₦1,800",  img: "yogurt-drink.jpg" },
      { name: "Ginger Immune Booster",       size: "Ginger · Lemon · Honey · 500ml",      price: "₦2,000",  img: "ginger-immune-booster.jpg" },
      { name: "Turmeric Immune Booster",     size: "Turmeric · Black Pepper · Honey · 500ml", price: "₦2,000", img: "turmeric-immune-booster.jpg" },
      { name: "Pineapple Ginger Drink",      size: "Pineapple · Ginger · 500ml",          price: "₦2,000",  img: "pineapple-ginger-drink.jpg" },
      { name: "Tiger Nut Milk",              size: "Plant-based · 500ml",                 price: "₦2,200",  img: "tiger-nut-milk.jpg" },
      { name: "Kale Cleanser",               size: "Kale · Cucumber · Apple · 500ml",     price: "₦2,200",  img: "kale-cleanser.jpg" },
      { name: "Lemon Honey Cleanser",        size: "Lemon · Honey · Cayenne · 500ml",     price: "₦1,800",  img: "lemon-honey-cleanser.jpg" },
    ],
  },
];
