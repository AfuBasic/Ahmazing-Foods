...
const items = [
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    sizes: [{ label: "500ml bottle", price: 2900 }], proteins: [], imageUrl: DRINK_IMG,
  },
  {
    category: "drinks",
  ...
  },
  {
    ...
    sizes: [{ label: "500ml bottle", price: 3100 }], proteins: [], imageUrl: DRINK_IMG,
  },
  {
    category: "drinks",
    name: "Ginger Immune Booster",
    description: "Fresh ginger shot blended with lemon, turmeric and honey. Fiery and reviving.",
    sizes: [{ label: "500ml bottle", price: 3200 }], proteins: [], imageUrl: DRINK_IMG,
  },
  {
    category: "drinks",
  ...
  },
  {
    ...
    sizes: [{ label: "500ml bottle", price: 3300 }], proteins: [], imageUrl: DRINK_IMG,
  },
  {
    category: "drinks",
    name: "Tiger Nut Milk",
  ...
  },
  {
    ...
    sizes: [{ label: "500ml bottle", price: 3700 }], proteins: [], imageUrl: DRINK_IMG,
  },
